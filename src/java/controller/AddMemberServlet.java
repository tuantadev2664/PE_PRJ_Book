 ...
 * @author FPTSHOP
 */
@WebServlet(name = "AddMemberServlet", urlPatterns = {"/add"})
public class AddMemberServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        membersDao.addNewMember(name, email);
            Members newMember = membersDao.getMemberByEmail(email);
            if (newMember != null) {
...
//            if (email.trim().equals(string.trim())) {
////                request.setAttribute("mess", "Add Fail Beacuse is Email is Exist");
//                isExistEmail = true;
